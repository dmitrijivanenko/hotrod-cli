...
class ProcessResourceModelFileTest extends TestCase
{
    /**
     * @test
     */
    public function it_should_call_the_create_command()
    {
        ...
        $application->find('create:resource-model')->shouldBeCalled()->willReturn($command->reveal());

        $processor = new ProcessResourceModelFile($appContainer->reveal());
