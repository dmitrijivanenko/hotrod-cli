...
class CreateInstallSchemaCommandTest extends TestCase
{
    protected $command;
    ...
    public function setUp()
    {
        ...
        $this->command = $appContainer->resolve(CreateInstallSchemaCommand::class);
    ...
    {
        $this->assertEquals('create:install-schema', $this->command->getName());
    }
