...
class CreateInstallDataCommandTest extends TestCase
{
    protected $command;
    ...
    public function setUp()
    {
        ...
        $this->command = $appContainer->resolve(CreateInstallDataCommand::class);
    ...
    {
        $this->assertEquals('create:install-data', $this->command->getName());
    }
